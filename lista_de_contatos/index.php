...
<head>
    ...
    <script src="https://kit.fontawesome.com/ca5c96c2d2.js" crossorigin="anonymous"></script>
        ...
        <form action="#" method="post" class="w3-row w3-text-blue w3-center" style="width: 70%;">
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnCadastrar" class="w3-button w3-block w3-margin w3-blue w3-cell
w3-round-large" style="width: 90%;">Cadastrar</button>
                </div>
            </div>
        </form>
    </div>
