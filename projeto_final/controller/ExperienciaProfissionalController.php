...
if(!isset($_SESSION)) { 
 ...
 class ExperienciaProfissionalController{ 
    ...
    public function inserir($inicio, $fim, $empresa, $descricao,$idusuario) { 
     ...
     } public function remover($id) { require_once '../Model/ExperienciaProfissional.php';
         $expP = new ExperienciaProfissional(); 
         $r = $expP->excluirDB($id);
          return $r;

     } public function gerarLista($idusuario) { require_once '../Model/ExperienciaProfissional.php';
        $expP = new ExperienciaProfissional(); 
